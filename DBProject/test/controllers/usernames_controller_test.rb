...
class UsernamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create username" do
    assert_difference('Username.count') do
      post usernames_url, params: { username: { customerid: @username.customerid, password: @username.password, username: @username.username } }
    end
  ...
  test "should update username" do
    patch username_url(@username), params: { username: { customerid: @username.customerid, password: @username.password, username: @username.username } }
