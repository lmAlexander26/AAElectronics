...
class TVsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tv" do
    assert_difference('Tv.count') do
      post tvs_url, params: { tv: { TVid: @tv.TVid, model: @tv.model, name: @tv.name, vendor: @tv.vendor, version: @tv.version } }
    end
  ...
  test "should update tv" do
    patch tv_url(@tv), params: { tv: { TVid: @tv.TVid, model: @tv.model, name: @tv.name, vendor: @tv.vendor, version: @tv.version } }
